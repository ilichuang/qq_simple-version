    ...
    ui(new Ui::Widget)
{
    ...
    b1 = new QAction(QIcon(":/images/menu.png"), tr("&皮肤1"), this);
    b2 = new QAction(QIcon(":/images/menu.png"), tr("&皮肤2"), this);
    b3 = new QAction(QIcon(":/images/menu.png"), tr("&皮肤3"), this);
    b4 = new QAction(QIcon(":/images/menu.png"), tr("&皮肤4"), this);
    b = new QAction(QIcon(":/images/menu.png"), tr("&皮肤5"), this);
    menu->addAction(b1);
    menu->addAction(b2);
    menu->addAction(b3);
    menu->addAction(b4);
